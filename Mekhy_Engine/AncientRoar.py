...
sfx_snore1 = pygame.mixer.Sound('sfx_snore1.wav')
sfx_snore2 = pygame.mixer.Sound('sfx_snore2.wav')
sfx_snore3 = pygame.mixer.Sound('sfx_snore3.wav')
